...
N = nEL;
resol = 0.01;
lvl = 4;% not more than 4 levels work!
obj = thbSplBasML(a,b,p,N,resol,lvl);
% obj.levelBas{2}.p = obj.levelBas{2}.p + 1;
% obj.levelBas{2}.knotVector = [a obj.levelBas{2}.knotVector b];
% obj.levelBas{2}.m = obj.levelBas{2}.m + 2;
% obj.levelBas{2}.n = obj.levelBas{2}.n + 2;
